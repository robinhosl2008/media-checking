<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <a href="{{ route('listar-produtos') }}">{{ __('Produtos') }}</a> / Criar
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('salvar-criacao-produtos') }}" method="post">
                        @csrf
                        ...
                        <div class="row mt-3">  
                            <div class="col-3">
                                ...
                                <input type="text" name="area_lar" id="area_lar" class="form-control aplay-decimal-mask" value="{{ old('area_lar') }}">
                            </div>
                            <div class="col-3">
                                <label for="area_alt" class="form-label">Área (Alt):</label>
                                <input type="text" name="area_alt" id="area_alt" class="form-control aplay-decimal-mask" value="{{ old('area_alt') }}">
                            </div>
                            <div class="col-3">
                                <label for="visual_lar" class="form-label">*Visual (Lar):</label>
                                <input type="text" name="visual_lar" id="visual_lar" class="form-control aplay-decimal-mask" value="{{ old('visual_lar') }}">
                                <p class="erro-input"><i>Campo obrigatório!</i></p>
                            </div>
                            <div class="col-3">
                                <label for="visual_alt" class="form-label">*Visual (Alt):</label>
                                <input type="text" name="visual_alt" id="visual_alt" class="form-control aplay-decimal-mask" value="{{ old('visual_alt') }}">
                                <p class="erro-input"><i>Campo obrigatório!</i></p>
                            </div>
                        </div>
